...
"""
from Udemy.Dia8.Proyecto.numeros import switch_sectores
def inicio():
    ...
    while True:
        ...
        opcion = input("Hola estimado/a, Por favor elija el sector al cual desea sacar turno para su atencion: \n(1) Cosmetica\n(2) Farmacia\n(3)Perfumeria\n(4)Salir\n")
        try:
            if int(opcion) == 1:

                    while True:
                        opcion = input("Esta seguro de sacar turno para sector Cosmetica?\n(1)SI\n(2)NO\n")
                        if opcion == '1':
                            switch_sectores(1)
                ...
                while True:
                    opcion = input("Esta seguro de sacar turno para sector Farmacia?\n(1)SI\n(2)NO\n")
                    if opcion == '1':
                        switch_sectores(2)
                ...
                while True:
                    opcion = input("Esta seguro de sacar turno para sector Perfumeria?\n(1)SI\n(2)NO\n")
                    if opcion == '1':
                        switch_sectores(3)
